...
const qaRecordRoutes = require("./routes/qaRecordRoutes");
const llmSampleRoutes = require("./routes/llmSampleRoutes");
...
app.use("/api/qa-records", qaRecordRoutes);
app.use("/api/llm-samples", llmSampleRoutes);
